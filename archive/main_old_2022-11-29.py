...
from app_repository_sql import Db_Table_Settings, Db_Table_Order_Detail, Db_Table_Finished_Good, Db_Table_Product, Db_Table_Console_Data, Db_Table_Data_Log
...
def set_global_counts_on_startup():
    ...
    # if max_db_exc < 0:
    #     max_db_exc = 0
    #     print("  - resetting to zero (was negative)")
    print("max_db_exe2...")
